...
This directory is the documentation hub for English OS.

Its job is to help an agent or developer find the right context quickly without reading the entire documentation tree.
...
This file explains how to use the documentation, how to inspect roadmap progress, and how to continue from the latest completed work.
...
These documents are expected to become the main source-of-truth files for the project:
...
2. [Product README](./product/README.md)
3. [Product Thesis](./product/thesis.md)
4. [MVP Definition](./product/mvp.md)
...
1. [Start Here](./start.md)
2. [System README](./system/README.md)
3. [Data Model](./system/data-model.md)
