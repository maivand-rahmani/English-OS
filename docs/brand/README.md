...
This section defines how English OS should feel, look, sound, and move.
...
2. [Style Doctrine](./style-doctrine.md)
3. [Visual Direction](./visual-direction.md)
...
Animation is expected to be an important part of the product identity.

## Canonical Style Direction

The recommended UI/UX style is:
